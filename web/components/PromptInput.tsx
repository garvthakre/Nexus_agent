...
const EXAMPLES = [
  "Export my email list to CSV and save it to Downloads",
  "Create a summary of quarterly sales and send via email",
  "Update product prices in my spreadsheet",
  "Generate a weekly report of completed tasks",
  "Backup my important files to a new folder",
]
